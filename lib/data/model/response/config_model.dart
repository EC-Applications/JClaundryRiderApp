class ConfigModel {
  ...
  ConfigModel.fromJson(Map<String, dynamic> json) {
    ...
    laundryTax = json['laundry_tax'].toDouble();
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['laundry_tax'] = this.laundryTax;
    return data;
  }
}
...
class BaseUrls {
  ...
  String dealImageUrl;
  String deliveryManDocumentUrl;
  String laundryBannerImageUrl;
  String laundryItemsImageUrl;
  ...
  BaseUrls(
      {this.productImageUrl,
        ...
        this.dealImageUrl,
        this.deliveryManDocumentUrl,
        this.laundryBannerImageUrl,
        this.laundryItemsImageUrl,
        this.servicesImageUrl
      });
  ...
  BaseUrls.fromJson(Map<String, dynamic> json) {
    ...
    dealImageUrl = json['deal_image_url'];
    deliveryManDocumentUrl = json['delivery_man_document_url'];
    laundryBannerImageUrl = json['laundry_banner_image_url'];
    laundryItemsImageUrl = json['laundry_items_image_url'];
    servicesImageUrl = json['services_image_url'];
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['deal_image_url'] = this.dealImageUrl;
    data['delivery_man_document_url'] = this.deliveryManDocumentUrl;
    data['laundry_banner_image_url'] = this.laundryBannerImageUrl;
    data['laundry_items_image_url'] = this.laundryItemsImageUrl;
    data['services_image_url'] = this.servicesImageUrl;
    return data;
  }
}
